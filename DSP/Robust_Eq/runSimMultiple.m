...
for snrLoop = 1:numSNRVals
    ...
    for itrLoop = 1:numItrs
        ...
        [ hCap,hCapComp,results,dataOut ] = robustEqualizer( d,u,r,FsBB,Na,Nc,La,Lc,lambdaSig,mu,numTrainingSymbols,numDataSymbols,pskMVal );
        ...
        [ numErr,results.SER ] = computeSER( results.dataIn(numTrainingSymbols+1:numSymbols),results.dataOut(numTrainingSymbols+1:numSymbols) );
        SER(snrLoop) = SER(snrLoop)+results.SER;
