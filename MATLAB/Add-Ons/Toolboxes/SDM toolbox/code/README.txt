SDM toolbox, a Matlab toolbox for spatial analysis and synthesis of spatial 
room acoustic impulse responses.

Contact information:
e-mail : 
Sakari.Tervo@aalto.fi / Jukka.Patynen@aalto.fi
Mailing address:
Sakari Tervo
Aalto University
...
The toolbox processes spatial room impulse responses, measured with a microphone array. The microphone array has to be specified as 
micLocs = microphone locations in Cartesian coordinates [numberOfMics 3] and in the order [x,y,z].
...
[2] J. Pätynen, S. Tervo, T. Lokki, "Analysis of concert hall acoustics via
...
[3] S. Tervo, J. Saarelma, J. Pätynen, P. Laukkanen, I. Huhtakallio,
...
[4] S. Tervo, J. Pätynen, N. Kaplanis, M. Lydolf, S. Bech, and T. Lokki
...
[5] P. Laukkanen "Evaluation of Studio Control Room Acoustics with 
Spatial Impulse Responses and Auralization", Master's thesis, 
