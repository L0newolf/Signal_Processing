...
* Version            : V2.0
* Date               : 12/07/2007
* Description        : Description of the ENET Example 3.
********************************************************************************
...
gives an example how to use the ENET interrupt to detect receiving frame and
to use the DMA instead of the memcpy function.
The example permits to send three frames and to recover them as received frames 
using the PHY loopback mode. 
The example shows hwo to use interrupt instead of polling to detect the frame 
recepiton. The frame will be copyied to the application buffer using the DMA 
instead of the memcpy function.  
